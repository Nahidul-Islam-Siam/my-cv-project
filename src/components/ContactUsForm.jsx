...
const ContactUs = () => {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2  py-10">
      ...
      <div className="flex items-center justify-start pr-8 w-full">
        <div className="w-full ">
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              className="w-36 bg-[#141718] text-white inter-font font-medium py-2 px-4 rounded-md hover:bg-indigo-700 focus:ring-2 focus:ring-indigo-500 focus:ring-opacity-50"
            >
             Send Message
            </button>
          </form>
