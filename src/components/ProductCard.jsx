  ...
  return (
    <div className="bg-white rounded-lg shadow-md overflow-hidden w-64">
      ...
      <div className="p-4">
        ...
        <button className="mt-4 w-full bg-[#141718] hover:bg-blue-700 text-[#FEFEFE] font-medium inter-font  text-base py-2 px-4 rounded-lg focus:outline-none focus:shadow-outline">
          Add to Cart
        </button>
      </div>
    </div>
