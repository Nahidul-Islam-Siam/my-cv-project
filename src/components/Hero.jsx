...
const Hero = () => {
  return (
    <div className="relative bg-[#FFC95B] mx-auto flex flex-col-reverse sm:flex-row items-center">
      ...
      <div className="w-full sm:w-1/2 flex flex-col items-center justify-center p-6 sm:p-12 text-center sm:text-left bg-[#FFC95B]">
      ...
      {/* Right Content: Background Image (on desktop, image is on the left) */}
